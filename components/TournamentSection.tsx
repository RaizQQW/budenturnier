...
export function TournamentSection({
  ...
  return (
    <section id={id} className="scroll-mt-20 rounded-xl border border-zinc-200/80 bg-zinc-50/40 px-5 py-6 shadow-sm sm:px-7 sm:py-7 dark:border-zinc-800/80 dark:bg-zinc-900/25">
